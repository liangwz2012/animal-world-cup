const BASE = "runtime-assets/rural-football/audio/";
// 微信小游戏统一读取原始 MP3，避免 M4A 在部分开发者工具/真机解码链上
// 出现加载失败或无声。当前源文件为 44.1 kHz、128 kbps MPEG Layer III。
const EXTENSION = ".mp3";
...
module.exports = { SoundBank, BASE, EXTENSION };

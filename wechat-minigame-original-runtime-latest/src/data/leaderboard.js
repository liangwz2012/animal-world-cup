const STORAGE_KEY = "animal-football:leaderboard:v1";
...
function createLeaderboard(options = {}) {
  ...
  function snapshot() {
    ...
    const values = Object.fromEntries(METRICS.map((metric) => [metric.id, metric.value(stats)]));
    return {

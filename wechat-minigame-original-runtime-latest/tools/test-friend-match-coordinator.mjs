...
hostClient.emit("room_created", {
  invite: inviteToken,
  room: { roomId, state: "waiting", config, guestOnline: false },
  self: { role: "host" },
});
...
hostClient.emit("room_state", {
  room: { roomId, state: "warmup", config, guestOnline: false, warmupMatchId },
  self: { role: "host" },
});
...
hostClient.emit("room_state", {
  room: { roomId, state: "warmup", config, guestOnline: true, guestReady: true, warmupMatchId, revision: 3 },
  self: { role: "host" },
});
...
hostClient.emit("load_match", { phase: "friend", role: "host", roomId, matchId: friendMatchId, config });
...
guestClient.emit("room_state", {
  room: { roomId, state: "warmup", config, guestOnline: true, guestReady: true, guestSpectating: false, warmupMatchId },
  self: { role: "guest" },
});
...
guestClient.emit("load_match", { phase: "warmup", spectator: true, roomId, matchId: warmupMatchId, config });
...
guestClient.emit("load_match", { phase: "friend", role: "guest", roomId, matchId: friendMatchId, config });
